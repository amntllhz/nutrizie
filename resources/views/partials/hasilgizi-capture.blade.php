<div id="capture-card" class="w-[768px] p-8 bg-white text-gray-800 font-in antialiased flex flex-col gap-y-6">

    {{-- Header Dokumen Hasil + Logo/Branding Singkat --}}
    <div class="flex justify-between items-end border-b-2 border-prim/20 pb-4">
        <div class="flex flex-col gap-y-1">
            <h1 class="text-prim font-bold text-xl">Hasil Cek Status Gizi</h1>
        ...
        <div class="text-right">
            <img class="h-5" src="{{ asset('img/nutrizie-logo.svg') }}" alt="">
        </div>
    </div>

    {{-- Card 1: Data Diri Balita --}}
    <div class="rounded-2xl ring-1 ring-inset ring-prim/20 overflow-hidden bg-white">
        <div class="bg-prim/10 px-5 py-3 border-b border-prim/10">
            <p class="text-prim font-semibold text-sm">Data Diri Balita</p>
        </div>

        <div class="grid grid-cols-2 divide-y divide-prim/10">
            {{-- Baris Atas: Nama & Jenis Kelamin --}}
            <div class="grid grid-cols-2 divide-x divide-prim/10 col-span-2">
                <div class="flex items-start gap-x-3 p-4">
                    <svg class="w-3 h-3 text-prim mt-0.5 flex-shrink-0" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="flex flex-col gap-y-0.5">
                        <p class="text-gray-400 text-xs font-medium">Nama Balita</p>
                        <p class="text-gray-800 font-bold text-sm">{{ $nama }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-x-3 p-4">
                    ...
                    <div class="flex flex-col gap-y-0.5">
                        <p class="text-gray-400 text-xs font-medium">Jenis Kelamin</p>
                        <p class="text-gray-800 font-bold text-sm">{{ $gender }}</p>
                    </div>
                </div>
            </div>

            {{-- Baris Bawah: Dimensi Fisik (4 kolom pasti) --}}
            <div class="grid grid-cols-4 divide-x divide-gray-100 col-span-2 border-t border-gray-100">
                <div class="flex items-start gap-x-2 p-4">
                    ...
                    <div class="flex flex-col gap-y-0.5">
                        <p class="text-gray-400 style text-[11px] font-medium">Usia</p>
                        <p class="text-gray-800 font-bold text-sm">{{ $umur }} Bulan</p>
                    </div>
                </div>

                <div class="flex items-start gap-x-2 p-4">
                    <svg class="h-3 w-3 text-prim mt-0.5 flex-shrink-0" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <div class="flex flex-col gap-y-0.5">
                        <p class="text-gray-400 text-[11px] font-medium">Berat Badan</p>
                        <p class="text-gray-800 font-bold text-sm">{{ $berat }} kg</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-x-2 p-4">
                    ...
                    <div class="flex flex-col gap-y-0.5">
                        <p class="text-gray-400 text-[11px] font-medium">Tinggi Badan</p>
                        <p class="text-gray-800 font-bold text-sm">{{ $panjang }} cm</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-x-2 p-4">
                    ...
                    <div class="flex flex-col gap-y-0.5">
                        <p class="text-gray-400 text-[11px] font-medium">Metode Ukur</p>
                        <p class="text-gray-800 font-bold text-sm">
                            {{ $metodeUkur === 'PB' ? 'Terlentang (PB)' : 'Berdiri (TB)' }}
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="rounded-2xl ring-1 ring-inset ring-prim/20 overflow-hidden bg-white">
        ...
        <div class="p-5 flex flex-col space-y-5">
            {{-- Tabel Status Gizi --}}
            <table class="w-full border-collapse text-sm text-gray-500">
                <thead>
                    <tr class="bg-gray-100">
                        <th class="border border-gray-200 text-gray-700 p-3 text-xs text-center font-bold w-[50%]">
                            Metode Perhitungan</th>
                        <th class="border border-gray-200 text-gray-700 p-3 text-xs text-center font-bold w-[20%]">
                            Z-Score</th>
                        <th class="border border-gray-200 text-gray-700 p-3 text-xs text-center font-bold w-[30%]">
                            Status Gizi</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="border border-gray-200 p-3 text-xs text-justify leading-relaxed">
                            Metode BB/U adalah metode untuk menilai status gizi anak berdasarkan berat badan relatif
                            terhadap umurnya.
                        </td>
                        <td class="border border-gray-200 p-3 text-sm text-center font-semibold text-gray-800">
                            {{ number_format($zscoreBbu, 2) }}
                        </td>
                        <td class="border border-gray-200 p-3 text-sm text-center font-bold text-prim">
                            {{ $statusBbu }}
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 p-3 text-xs text-justify leading-relaxed">
                            Metode PB/U adalah metode untuk menilai status gizi anak berdasarkan Panjang/Tinggi badan
                            relatif terhadap umurnya.
                        </td>
                        <td class="border border-gray-200 p-3 text-sm text-center font-semibold text-gray-800">
            ...
            {{-- Catatan & Rekomendasi --}}
            <div class="flex space-x-3 bg-prim/5 rounded-xl p-4 ring ring-prim/10 ring-inset">
                <div class="flex items-start flex-shrink-0 mt-0.5">
                    <svg class="w-3 h-3 text-prim" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <div class="flex flex-col space-y-1">
                    <p class="text-gray-700 font-bold text-xs">Catatan & Rekomendasi</p>
                    <p class="text-gray-500 text-xs text-justify leading-relaxed">{{ $catatan }}</p>
                </div>
            </div>
        </div>
    </div>

    {{-- Footer Singkat untuk Hasil Cetak --}}
    <div class="text-center text-[10px] text-gray-400 mt-2 border-t border-gray-100 pt-3">
        Dibuat otomatis oleh Nutrizie - Nutrizie 2026
    </div>
</div>
