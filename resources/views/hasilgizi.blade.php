...
@push('vite_script')
    @vite(['resources/js/hasilgizi.js'])
@endpush
...
@section('content')
    ...
    "
                        ...
                        <svg class="h-4 w-4 text-white" width="100%" height="100%" viewBox="0 0 24 24"
                        ...
                        <span x-text="downloading ? 'Menyiapkan...' : 'Simpan Hasil'"></span>
                    </button>
                </div>
            </div>
        </section>
