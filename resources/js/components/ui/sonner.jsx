...
const Toaster = ({ ...props }) => {
  return (
    <Sonner
      ...
      icons={{
        success:
          <svg className='size-4 text-prim' width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        error:
          <svg className='size-4 text-red-500' width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
